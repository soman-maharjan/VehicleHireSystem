...
public class UserController implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == view.jBtnRegisterCustomer) {
			...
			errors = model.validateCustomer(view.getIdentificationNumber(), view.getCorporationName(), view.getAddress(),
					view.getPhoneNumber(), view.getEmail(), view.getUsername(), view.getPassword());
